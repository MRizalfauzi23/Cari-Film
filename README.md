...
/*# sourceMappingURL=bootstrap.css.map */
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
          <a class="navbar-brand" href="#">RIZAL FILM</a>
    ...
    <div class="row mt-3 justify-content-center" >
        <div class="col-md-8">
            ...
            <div class="input-group mb-3">
                ...
                <span class="btn btn-dark" id="search-button">Search</span>
              </div>
        </div>
    </div>
    ...
    $.ajax({
        ...
        success: function (movie) {
            if (movie.Response === "True") {
                ...
                <div class="col-md-8">
                <ul class="list-group">
                    <li class="list-group-item"><h3>`+movie.Title+`<h/3></li>
